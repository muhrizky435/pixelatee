...
export default function DetailServiceCMS() {
    const navigate = useNavigate();
  return (
    <NavBarCMS>
      {/* Breadcrumb */}
      <div className="mb-4 text-sm text-blue-600">/ Layanan / Detail</div>
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <div className="space-y-2 mb-6">
          <p className="text-lg font-semibold text-blue-600">Layanan X</p>
        </div>
